...
import PlaylistLista from './playlistLista'
import CrearplaylistForm from './crearplaylist'
import AgregarCancionplaylistForm from './agregarcancionPlaylist'
import BorrarCancionplaylistForm from './BorrarcancionPlaylist'
import BorrarplaylistForm from './BorrarPlaylist'
      ...
      <div className="row mt-3">
        <div className="col">
          ...
          <div className="tab-content">
            ...
            <AgregarCancionplaylistForm/>            
            </div>
            <div className={`tab-pane ${activeTab === 3 ? 'active' : ''}`}>
                        
            <BorrarCancionplaylistForm/>            
            </div>
